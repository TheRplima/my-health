...
class WaterIntakeContainerResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'name' => isset($this['name']) ? $this['name'] : (isset($this->name) ? $this->name : null),
            'size' => isset($this['size']) ? $this['size'] : (isset($this->size) ? $this->size : null),
            'icon' => isset($this['icon']) ? $this['icon'] : (isset($this->icon) ? $this->icon : null),
            'active' => isset($this['active']) ? $this['active'] : (isset($this->active) ? $this->active : null),
